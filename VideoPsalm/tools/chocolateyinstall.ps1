...
$packageArgs = @{
  ...
  softwareName  = 'videopsalm' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
Install-ChocolateyPackage 'videopsalm' 'msi' '/quiet' 'https://bit.ly/VideoPsalm_1_29_Setup' 
