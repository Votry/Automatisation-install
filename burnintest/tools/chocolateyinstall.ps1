...
$packageArgs = @{
  ...
  softwareName  = 'burnintest*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
Install-ChocolateyPackage 'burnintest' 'exe' '/VERYSILENT' 'https://www.passmark.com/downloads/bitpro9_2_1009.exe' 
